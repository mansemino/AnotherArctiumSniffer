...
Sniffer for 5.3.x & 5.4.x (32 bits) retail clients. It will create Arctium Dump files, to browse and parse them with my ArctiumSnifferBrowser or with your own tools...

Features:

- Universal sniffer. You don't need updates for future 5.3.x / 5.4.x clients (I'm still crossing fingers ^^)
